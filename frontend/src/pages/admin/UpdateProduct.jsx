...
const UpdateProduct = ({ navigate, editId, setEditId }) => {
    ...
    <div className="max-w-3xl text-sm md:text-base mx-auto p-8 bg-white rounded-xl shadow-lg mt-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6">
        ...
        <div>
         ...
         {previewImages.length > 0&& <button onClick={clearImagesHandler} type="button" className="bg-red-500 w-full mt-4 text-white py-1.5 rounded-lg  transition shadow-md hover:shadow-lg ">Delete All Images</button>}
